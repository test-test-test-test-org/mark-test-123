...
```
npm create cloudflare@latest -- --template=cloudflare/templates/restless-bar-33e5
```

## Preview Deployment

A live public deployment of this template is available at [https://restless-bar-33e5.templates.workers.dev](https://restless-bar-33e5.templates.workers.dev)
